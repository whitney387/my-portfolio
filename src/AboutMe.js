...
export default function AboutMe() {
  return (
    <section id="about" className="container py-5">
      ...
      <p>
        I am a junior front-end developer and a third-year Economics student
        with a diploma in web development from
        <strong> SheCodes </strong>. I am passionate about building clean,
